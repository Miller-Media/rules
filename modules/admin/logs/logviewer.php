...
{	
	...
	{		
		...
		{
			\IPS\Output::i()->redirect( $entity->url()->setQueryString( array( 'log' => $log->id, 'logtab' => $log->id, 'logsortby' => \IPS\Request::i()->sortby, 'logsortdir' => \IPS\Request::i()->sortdirection, 'logpage' => \IPS\Request::i()->page ) ) );
		}
	}
